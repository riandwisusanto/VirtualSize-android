...
import com.example.virtualsize.adapter.AdapterPromo
...
class FragmentHome : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        menu1.setOnClickListener {
            ...
            intent.putExtra("jenis", "Handphone")
        ...
        val image = intArrayOf(
            R.drawable.beranda_card1,
            R.drawable.beranda_card2,
            R.drawable.beranda_card3
        )
